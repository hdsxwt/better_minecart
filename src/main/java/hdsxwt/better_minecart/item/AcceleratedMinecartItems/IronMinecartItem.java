...
public class IronMinecartItem extends AcceleratedMinecartItem{

	public IronMinecartItem(Settings settings) {
		super(settings);
	}
	...
	public EntityType<AcceleratedMinecartEntity> getMinecart() {
		return IronMinecart.IRON_MINECART;
	}
	...
	public static void register() {
		...
		ACCELERATED_MINECART = Registry.register(Registries.ITEM,
				Identifier.of(BetterMinecartMod.MOD_ID, "iron_minecart"),
				new IronMinecartItem(ACCELERATED_MINECART_SETTINGS)
		);
