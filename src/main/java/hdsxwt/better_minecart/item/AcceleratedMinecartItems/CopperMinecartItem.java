...
public class CopperMinecartItem extends AcceleratedMinecartItem{

	public CopperMinecartItem(Settings settings) {
		super(settings);
	}

	@Override
	public EntityType<AcceleratedMinecartEntity> getMinecart() {
		return CopperMinecart.COPPER_MINECART;
	}
	...
	public static void register() {
		...
		ACCELERATED_MINECART = Registry.register(Registries.ITEM,
				Identifier.of(BetterMinecartMod.MOD_ID, "copper_minecart"),
				new CopperMinecartItem(ACCELERATED_MINECART_SETTINGS)
		);
